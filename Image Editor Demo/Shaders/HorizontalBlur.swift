...
//  Image Editor Demo
//
//  Created by Volodymyr Shynkarenko on 27.01.2023.
//

import Metal

final class HorizontalBlur: AbstractShader {
    ...
    init(library: MTLLibrary) throws {
        ...
        constantValues.setConstantValue(&self.deviceSupportsNonuniformThreadgroups,
                                        type: .bool,
                                        index: 0)
        let function = try library.makeFunction(name: "horisontalBlur",
